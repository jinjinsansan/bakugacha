-- 024: admin plays do not consume stock or produce persistent records
--
-- Changes vs 023:
--   When p_is_admin = true:
--     - coins are already skipped (existing behavior)
--     - stock_remaining is NOT decremented
--     - gacha_results is NOT inserted (admin plays are test plays)
--     - card issuance is skipped
--     - prize_claims is not created
--     - max_winners count is NOT affected
--   Non-admin plays behave exactly as in 023.
