...
import { updateCd2Settings, updateEcardSettings, updateElevatorSettings, updateKeibaSettings, updateKeibaCardSettings, updateRaiseKentaSettings, updateRaiseShoichiSettings, updateAppSettings, updateCardExchangeRates, updateMaintenanceSettings } from '@/app/admin/actions';
